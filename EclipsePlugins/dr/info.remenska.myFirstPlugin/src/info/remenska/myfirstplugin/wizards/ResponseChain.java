...
public class ResponseChain extends PropertyPattern {
	Model m;

	public ResponseChain(Model m) {
		this.m = m;
	}
	...
	public void draw(int scope) {
		...
		case PropertyPattern.AFTER:
			draw_afterQResponseChain(m);
			break;
		case PropertyPattern.AFTER_LAST:
			draw_afterLastQResponseChain(m);
			break;
		case PropertyPattern.BETWEEN:
			draw_betweenQandRResponseChain(m);
			break;
			
		case PropertyPattern.UNTIL:
			draw_UntilRResponseChain(m);
			break;
		case PropertyPattern.AFTER_UNTIL:
			draw_afterQUntilRResponseChain(m);
			break;

		case PropertyPattern.GLOBALLY:
			draw_globallyResponseChain(m);
			break;
			
		case PropertyPattern.AFTER_LAST_UNTIL:
			draw_afterLastQUntilRResponseChain(m);
			break;
			
			
		case PropertyPattern.BETWEEN_LAST:
			draw_betweenLastQandRResponseChain(m);
			break;
		}
	}

	public void draw_betweenLastQandRResponseChain(Model m2) {
		int random = (int )(Math.random() * 5000 + 1);

		Collaboration coll = (Collaboration) m.createPackagedElement("Collab_BetweenLastQandR_ResponseChain_Pattern_" + random, UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior("Inter_BetweenLastQandR_ResponseChain_Pattern_" +random, UMLPackage.eINSTANCE.getInteraction());
		...
		d.setName("Diag_SD_BetweenLastQandR_ResponseChain_Pattern_"+random);		
		...
		cd.setName("Diag_COM_BetweenLastQandR_ResponseChain_Pattern_"+random);			
	}

	public void draw_afterLastQUntilRResponseChain(Model m2) {
		
		int random = (int )(Math.random() * 5000 + 1);

		Collaboration coll = (Collaboration) m.createPackagedElement("Collab_AfterLastQUntilR_ResponseChain_Pattern_" + random, UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior("Inter_AfterLastQUntilR_ResponseChain_Pattern_" +random, UMLPackage.eINSTANCE.getInteraction());
		afterLastQ(m, coll, inter);
		...
		// and finally... create the diagrams
				// note slightly different syntax here
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.SEQUENCE_LITERAL,inter);
		d.setName("Diag_SD_AfterLastQUntilR_ResponseChain_Pattern_"+random);		
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);		
			
		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.COMMUNICATION_LITERAL,inter);
		cd.setName("Diag_COM_AfterLastQUntilR_ResponseChain_Pattern_"+random);		
				
	}

	public void draw_afterLastQResponseChain(Model m2) {
		int random = (int )(Math.random() * 5000 + 1);

		Collaboration coll = (Collaboration) m.createPackagedElement("Collab_AfterLastQ_Response_Pattern_" + random, UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior("Inter_AfterLastQ_Absence_Pattern_" +random, UMLPackage.eINSTANCE.getInteraction());
		afterLastQ(m, coll, inter);
	...
	public void draw_UntilRResponseChain(Model m2) {
		
		int random = (int )(Math.random() * 5000 + 1);

		Collaboration coll = (Collaboration) m.createPackagedElement("Collab_UntilR_ResponseChain_Pattern_" + random, UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior("Inter_UntilR_ResponseChain_Pattern_" +random, UMLPackage.eINSTANCE.getInteraction());
		...
		// and finally... create the diagrams
				// note slightly different syntax here
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.SEQUENCE_LITERAL,inter);
		d.setName("Diag_SD_UntilR_ResponseChain_Pattern_"+random);		
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);		
			
		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.COMMUNICATION_LITERAL,inter);
		cd.setName("Diag_COM_UntilR_ResponseChain_Pattern_"+random);				
	}

	public void draw_beforeRResponseChain(Model m){
...
public void draw_afterQUntilRResponseChain(Model m){
	...
	public void draw_afterQResponseChain(Model m){
		int random = (int )(Math.random() * 5000 + 1);
	...
	public void draw_globallyResponseChain(Model m){
		int random = (int )(Math.random() * 5000 + 1);

		Collaboration coll = (Collaboration) m.createPackagedElement("Collab_Globally_ResponseChain_Pattern_" + random, UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior("Inter_Globally_ResponseChain_Pattern_" +random, UMLPackage.eINSTANCE.getInteraction());
		...
		// note slightly different syntax here
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.SEQUENCE_LITERAL,inter);
		d.setName("Diag_SD_Globally_ResponseChain_Pattern_"+random);		
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);		
	
		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.COMMUNICATION_LITERAL,inter);
		cd.setName("Diag_COM_Globally_ResponseChain_Pattern_"+random);
	}
	public void draw_betweenQandRResponseChain(Model m){
		int random = (int )(Math.random() * 5000 + 1);

		Collaboration coll = (Collaboration) m.createPackagedElement("Collab_BetweenQandR_ResponseChain_Pattern_" + random, UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior("Inter_BetweenQandR_ResponseChain_Pattern_" +random, UMLPackage.eINSTANCE.getInteraction());
		afterQ(m, coll, inter);
		response_chain(m,coll, inter);
		beforeR(m,coll,inter);
		...
		// note slightly different syntax here
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.SEQUENCE_LITERAL,inter);
		d.setName("Diag_SD_BetweenQandR_ResponseChain_Pattern_"+random);		
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);		
	
		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.COMMUNICATION_LITERAL,inter);
		cd.setName("Diag_COM_BetweenQandR_ResponseChain_Pattern_"+random);	
	}

public void response_chain(Model m, Collaboration coll, Interaction inter){
