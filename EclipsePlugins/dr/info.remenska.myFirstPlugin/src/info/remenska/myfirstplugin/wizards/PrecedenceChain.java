...
public class PrecedenceChain extends PropertyPattern {
	Model m;

	public PrecedenceChain(Model m) {
		this.m = m;
	}
	...
	public void draw(int scope) {
		...
		case PropertyPattern.BEFORE:
			draw_beforeRPrecedenceChain(m);
			break;
		case PropertyPattern.AFTER:
			draw_afterQPrecedenceChain(m);
			break;
		case PropertyPattern.AFTER_LAST:
			draw_afterLastQPrecedenceChain(m);
			break;
		case PropertyPattern.BETWEEN:
			draw_betweenQandRPrecedenceChain(m);
			break;
		case PropertyPattern.AFTER_UNTIL:
			draw_afterQUntilRPrecedenceChain(m);
			break;
		case PropertyPattern.UNTIL:
			draw_UntilRPrecedenceChain(m);
			break;

		case PropertyPattern.GLOBALLY:
			draw_globallyPrecedenceChain(m);
			break;
			
		case PropertyPattern.AFTER_LAST_UNTIL:
			draw_afterLastQUntilRPrecedenceChain(m);
			break;
			
		case PropertyPattern.BETWEEN_LAST:
			draw_betweenLastQandRPrecedenceChain(m);
			break;
		}
	}

		public void draw_betweenLastQandRPrecedenceChain(Model m2) {
			int random = (int )(Math.random() * 5000 + 1);

			Collaboration coll = (Collaboration) m.createPackagedElement("Collab_BetweenLastQandR_PrecedenceChain_Pattern_" + random, UMLPackage.eINSTANCE.getCollaboration());
			Interaction inter = (Interaction) coll.createOwnedBehavior("Inter_BetweenLastQandR_PrecedenceChain_Pattern_" +random, UMLPackage.eINSTANCE.getInteraction());
			afterLastQ(m, coll, inter);
			precedence_chain(m,coll, inter);
			...
			d.setName("Diag_SD_BetweenLastQandR_PrecedenceChain_Pattern_"+random);		
			...
			cd.setName("Diag_COM_BetweenLastQandR_PrecedenceChain_Pattern_"+random);		
	}

		public void draw_afterLastQUntilRPrecedenceChain(Model m2) {
			int random = (int )(Math.random() * 5000 + 1);

			Collaboration coll = (Collaboration) m.createPackagedElement("Collab_AfterLastQ_UntilR_PrecedenceChain_Pattern_" + random, UMLPackage.eINSTANCE.getCollaboration());
			Interaction inter = (Interaction) coll.createOwnedBehavior("Inter_AfterLastQ_UntilR_PrecedenceChain_Pattern_" +random, UMLPackage.eINSTANCE.getInteraction());
			afterLastQ(m, coll, inter);
			...
			// and finally... create the diagrams
					// note slightly different syntax here
			Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.SEQUENCE_LITERAL,inter);
			d.setName("Diag_SD_AfterLastQ_UntilR_PrecedenceChain_Pattern_"+random);		
			UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);		
				
			Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.COMMUNICATION_LITERAL,inter);
			cd.setName("Diag_COM_AfterLastQ_UntilR_PrecedenceChain_Pattern_"+random);			
	}

		public void draw_afterLastQPrecedenceChain(Model m2) {
			int random = (int )(Math.random() * 5000 + 1);

			Collaboration coll = (Collaboration) m.createPackagedElement("Collab_AfterLastQ_PrecedenceChain_Pattern_" + random, UMLPackage.eINSTANCE.getCollaboration());
			Interaction inter = (Interaction) coll.createOwnedBehavior("Inter_AfterLastQ_PrecedenceChain_Pattern_" +random, UMLPackage.eINSTANCE.getInteraction());
			afterLastQ(m, coll, inter);
			...
			// note slightly different syntax here
			Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.SEQUENCE_LITERAL,inter);
			d.setName("Diag_SD_AfterLastQ_PrecedenceChain_Pattern_"+random);		
			UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);		
		
			Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.COMMUNICATION_LITERAL,inter);
			cd.setName("Diag_COM_AfterLastQ_PrecedenceChain_Pattern_"+random);			
	}

		public void draw_UntilRPrecedenceChain(Model m2) {
			int random = (int )(Math.random() * 5000 + 1);

			Collaboration coll = (Collaboration) m.createPackagedElement("Collab_UntilR_PrecedenceChain_Pattern_" + random, UMLPackage.eINSTANCE.getCollaboration());
			Interaction inter = (Interaction) coll.createOwnedBehavior("Inter_UntilR_PrecedenceChain_Pattern_" +random, UMLPackage.eINSTANCE.getInteraction());
			...
			// and finally... create the diagrams
					// note slightly different syntax here
			Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.SEQUENCE_LITERAL,inter);
			d.setName("Diag_SD_UntilR_PrecedenceChain_Pattern_"+random);		
			UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);		
				
			Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.COMMUNICATION_LITERAL,inter);
			cd.setName("Diag_COM_UntilR_PrecedenceChain_Pattern_"+random);				
	}

		public void draw_beforeRPrecedenceChain(Model m){
			int random = (int )(Math.random() * 5000 + 1);

			Collaboration coll = (Collaboration) m.createPackagedElement("Collab_BeforeR_PrecedenceChain_Pattern_" + random, UMLPackage.eINSTANCE.getCollaboration());
			Interaction inter = (Interaction) coll.createOwnedBehavior("Inter_BeforeR_PrecedenceChain_Pattern_" +random, UMLPackage.eINSTANCE.getInteraction());
			
			precedence_chain(m, coll, inter);
			beforeR(m,coll,inter);
			Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.SEQUENCE_LITERAL,inter);
			d.setName("Diag_SD_BeforeR_PrecedenceChain_Pattern_"+random);		
			UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);		
		
			Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.COMMUNICATION_LITERAL,inter);
			cd.setName("Diag_COM_BeforeR_PrecedenceChain_Pattern_"+random);	
			
		}
		

		public void draw_afterQUntilRPrecedenceChain(Model m){
			int random = (int )(Math.random() * 5000 + 1);

			Collaboration coll = (Collaboration) m.createPackagedElement("Collab_AfterQ_UntilR_PrecedenceChain_Pattern_" + random, UMLPackage.eINSTANCE.getCollaboration());
			Interaction inter = (Interaction) coll.createOwnedBehavior("Inter_AfterQ_UntilR_PrecedenceChain_Pattern_" +random, UMLPackage.eINSTANCE.getInteraction());
			afterQ(m, coll, inter);
			...
			// and finally... create the diagrams
					// note slightly different syntax here
			Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.SEQUENCE_LITERAL,inter);
			d.setName("Diag_SD_AfterQ_UntilR_PrecedenceChain_Pattern_"+random);		
			UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);		
				
			Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.COMMUNICATION_LITERAL,inter);
			cd.setName("Diag_COM_AfterQ_UntilR_PrecedenceChain_Pattern_"+random);		
		}
		
	public void draw_afterQPrecedenceChain(Model m){
		int random = (int )(Math.random() * 5000 + 1);

		Collaboration coll = (Collaboration) m.createPackagedElement("Collab_AfterQ_PrecedenceChain_Pattern_" + random, UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior("Inter_AfterQ_PrecedenceChain_Pattern_" +random, UMLPackage.eINSTANCE.getInteraction());
		afterQ(m, coll, inter);
		...
		// note slightly different syntax here
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.SEQUENCE_LITERAL,inter);
		d.setName("Diag_SD_AfterQ_PrecedenceChain_Pattern_"+random);		
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);		
	
		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.COMMUNICATION_LITERAL,inter);
		cd.setName("Diag_COM_AfterQ_PrecedenceChain_Pattern_"+random);		
	}

	public void draw_globallyPrecedenceChain(Model m){
		
		int random = (int )(Math.random() * 5000 + 1);

		Collaboration coll = (Collaboration) m.createPackagedElement("Collab_Globally_PrecedenceChain_Pattern_" + random, UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior("Inter_Globally_PrecedenceChain_Pattern_" +random, UMLPackage.eINSTANCE.getInteraction());
		...
		// note slightly different syntax here
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.SEQUENCE_LITERAL,inter);
		d.setName("Diag_SD_Globally_PrecedenceChain_Pattern_"+random);		
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);		
	
		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.COMMUNICATION_LITERAL,inter);
		cd.setName("Diag_COM_Globally_PrecedenceChain_Pattern_"+random);	
	
	}

	public void draw_betweenQandRPrecedenceChain(Model m){
		
		int random = (int )(Math.random() * 5000 + 1);

		Collaboration coll = (Collaboration) m.createPackagedElement("Collab_BetweenQandR_PrecedenceChain_Pattern_" + random, UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior("Inter_BetweenQandR_PrecedenceChain_Pattern_" +random, UMLPackage.eINSTANCE.getInteraction());
		afterQ(m, coll, inter);
		precedence_chain(m,coll, inter);
		beforeR(m,coll,inter);
		...
		// note slightly different syntax here
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.SEQUENCE_LITERAL,inter);
		d.setName("Diag_SD_BetweenQandR_PrecedenceChain_Pattern_"+random);		
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);		
	
		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.COMMUNICATION_LITERAL,inter);
		cd.setName("Diag_COM_BetweenQandR_PrecedenceChain_Pattern_"+random);
	}
	
	public void precedence_chain(Model m, Collaboration coll, Interaction inter){
		...
		regMessage(m, coll, inter, QuestionTreePage.textEventC);
