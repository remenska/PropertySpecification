...
public class Questionnaire {
	...
	public static 				TreeNode<String> answ111111 = quest11111.addChild("Only the first occurence of START starts the restricted interval; later occurences of START do not have an effect.", false);
	public static 				TreeNode<String> answ111112 = quest11111.addChild("Only the last occurence of START starts the restricted interval; each occurence of START resets the beginning of a restricted interval. ", false);
	...
	public static 				TreeNode<String> answ111211 = quest11121.addChild("Yes, if END does not occur, the behavior is required to hold throughout the entire event sequence.", false);
	public static 				TreeNode<String> answ111212 = quest11121.addChild("No, if END does not occur, the behavior not required to hold anywhere in the event sequence.", false);
	...
	public static 			TreeNode<String> quest11132 = 	answ1113.addChild("If an occurence of START is not followed by an occurence of END, is the behavior still required to hold, until the end of the event sequence?", true);
			...
			public static 				TreeNode<String> answ111332 = quest11133.addChild("The new occurence of START does not have an effect; no new occurence of START will ever start a new restricted interval. ", false);
			public static 		TreeNode<String> quest112 = answ11.addChild("Are there any exceptional events such that if any of them occurs the property behavior may not be required to hold? ", true);
			public static 			TreeNode<String> answ1121 = quest112.addChild("No.", false);
			public static 			TreeNode<String> answ1122 = quest112.addChild("Yes, if exceptional event X occurs, the property behavior may not be required to hold", false);
...
//////
			...
			public static 		TreeNode<String> aansw1111 = qquest111.addChild("A is never allowed to occur", false);
			...
			public static 				TreeNode<String> aansw11111 = qquest1111.addChild("No.", false);
			public static 				TreeNode<String> aansw11112 = qquest1111.addChild("Yes, if exceptional event X occurs when A has not yet occured, the behavior is not required to hold.", false);
			...
			public static 						TreeNode<String> aansw1111211 = qquest111121.addChild("In that case, the event sequence is not acceptable.", false);
			...
			public static 		TreeNode<String> aansw1112 = qquest111.addChild("A is allowed to occur at least once.", false);				
			public static 			TreeNode<String> qquest11121 = aansw1112.addChild("Are there any exceptional events such that if any of them occurs, the property \n behavior may not be required to hold?", true);
			...
			public static 						TreeNode<String> aansw11121211 = qquest1113121.addChild("In that case, the event sequence is not acceptable.", false);
			public static 						TreeNode<String> aansw11121212 = qquest1113121.addChild("Even in that case, the event sequence is still considered acceptable.", false);
			...
			public static 				TreeNode<String> aansw121111 = qquest12111.addChild("Yes, A is required to occur.", false);
			public static 				TreeNode<String> aansw121112 = qquest12111.addChild("No, A is not required to occur.", false);
			public static 		TreeNode<String> aansw1212 = qquest121.addChild("B is not allowed to occur until after A occurs.", false);
			...
			public static 				TreeNode<String> aansw121211 = qquest12121.addChild("Yes, A is required to occur, whether or not B eventually occurs.", false);
			public static 				TreeNode<String> aansw121212 = qquest12121.addChild("No, A is not required to occur and, if it does not occur, B is never allowed to occur.", false);
			public static 		TreeNode<String> aansw1213 = qquest121.addChild("Both statements describe how A and B interact: if A occurs, B is required to occur subsequently, and B is not allowed to occur until after A occurs.", false);
			public static 			TreeNode<String> qquest12131 = aansw1213.addChild("Is A required to occur?", true);
			public static 				TreeNode<String> aansw121311 = qquest12131.addChild("Yes, A is required to occur.", false);
			public static 				TreeNode<String> aansw121312 = qquest12131.addChild("No, A is not required to occur.", false);
	
			public static 	TreeNode<String> quest122 = aansw12.addChild("After A occurs, is A allowed to occur again before the first subsequent B occurs?", true);
			public static 	TreeNode<String> aansw1221 = quest122.addChild("Yes, A is allowed to occur again, zero or more times, before the first subsequent B occurs", false);
			public static 		TreeNode<String> aansw1222 = quest122.addChild("No, A is not allowed to occur again before the first subsequent B occurs.", false);
			public static 	TreeNode<String> quest123 = aansw12.addChild("After A and the first subsequent B occur, is A allowed to occur again?", true);
			public static 		TreeNode<String> aansw1232 = quest123.addChild("No, A is not allowed to occur again.", false);
			public static 			TreeNode<String> qquest12321 = aansw1232.addChild("Is B allowed to occur again?", true);
			public static 				TreeNode<String> aansw123211 = qquest12321.addChild("Yes, B is allowed to occur again zero or more times.", false);
			public static 				TreeNode<String> aansw123212 = qquest12321.addChild("No, B is not allowed to occur again.", false);
			public static 	TreeNode<String> aansw1231 = quest123.addChild("Yes, A is allowed to occur again.", false);
			...
			public static 				TreeNode<String> aansw123113 = qquest12311.addChild("Yes, B is allowed to occur again, zero or more times, whether or not another A occurs.", false);
			...
			public static 						TreeNode<String> aansw12311311 = qquest1231131.addChild("Yes, if A does occur again, the restrictions described on those events would again apply.", false);
			...
			public static 		TreeNode<String> aansw1241 = qquest124.addChild("No.", false);
			...
			public static 				TreeNode<String> aansw124212 = qquest12421.addChild("Even in that case, the event sequence is still considered acceptable.", false);
