	...
	public void createControl(Composite parent) {
		...
		button.addSelectionListener(new SelectionAdapter(){
			public void widgetSelected(SelectionEvent event){
				...
				//comm.setFocus();
//				ModelSearchFilteredUMLClassSelectionDialog dialog = new ModelSearchFilteredUMLClassSelectionDialog(Display.getDefault().getActiveShell(),false);
				DanielaSelectionDialog dialog = new DanielaSelectionDialog(getShell());
//				ModelSearchFilteredUMLClassSelectionDialog dialog = new ModelSearchFilteredUMLClassSelectionDialog(Display.getDefault().getActiveShell(), true);
