...
//										 System.out.println("Model NAMESPACE"+((Model) model).getNamespace());
										 ...
										 System.out.println("------------...");
										if(model.getName().equalsIgnoreCase("MyModel")){
...
private void createSequenceDiagram(Model m) {
		...
		Collaboration coll = (Collaboration) m.createPackagedElement("Collaboration1", UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior("My interaction", UMLPackage.eINSTANCE.getInteraction());
