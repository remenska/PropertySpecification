...
public class PrecedenceChain2 extends PropertyPattern {
	Model m;

	public PrecedenceChain2(Model m) {
		this.m = m;
	}
	...
	public void draw(int scope) {
		...
		case PropertyPattern.AFTER_LAST_UNTIL:
			draw_afterLastQUntilRPrecedenceChain2(m);
			break;
		case PropertyPattern.BETWEEN_LAST:
			draw_betweenLastQandRPrecedenceChain2(m);
			break;
		}
	}

	public void draw_betweenLastQandRPrecedenceChain2(Model m2) {
		int random = (int )(Math.random() * 5000 + 1);

		Collaboration coll = (Collaboration) m.createPackagedElement("Collab_BetweenLastQandR_PrecedenceChain2_Pattern_" + random, UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior("Inter_BetweenLatQandR_PrecedenceChain2_Pattern_" +random, UMLPackage.eINSTANCE.getInteraction());
		...
		d.setName("Diag_SD_BetweenLastQandR_PrecedenceChain2_Pattern_"+random);		
		...
		cd.setName("Diag_COM_BetweenLastQandR_PrecedenceChain2_Pattern_"+random);		
	}

	public void draw_afterLastQUntilRPrecedenceChain2(Model m2) {
		int random = (int )(Math.random() * 5000 + 1);

		Collaboration coll = (Collaboration) m.createPackagedElement("Collab_AfterLastQUntilR_PrecedenceChain2_Pattern_" + random, UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior("Inter_AfterLastQUntilR_PrecedenceChain2_Pattern_" +random, UMLPackage.eINSTANCE.getInteraction());
		afterLastQ(m, coll, inter);
		...
		// and finally... create the diagrams
				// note slightly different syntax here
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.SEQUENCE_LITERAL,inter);
		d.setName("Diag_SD_AfterLastQUntilR_PrecedenceChain2_Pattern_"+random);		
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);		
			
		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.COMMUNICATION_LITERAL,inter);
		cd.setName("Diag_COM_AfterLastQUntilR_PrecedenceChain2_Pattern_"+random);		
	}
	...
	public void draw_beforeRPrecedenceChain2(Model m){
		...
		public void draw_afterQUntilRPrecedenceChain2(Model m){
			int random = (int )(Math.random() * 5000 + 1);

			Collaboration coll = (Collaboration) m.createPackagedElement("Collab_AfterQUntilR_PrecedenceChain2_Pattern_" + random, UMLPackage.eINSTANCE.getCollaboration());
			Interaction inter = (Interaction) coll.createOwnedBehavior("Inter_AfterQUntilR_PrecedenceChain2_Pattern_" +random, UMLPackage.eINSTANCE.getInteraction());
			afterQ(m, coll, inter);
			...
			// and finally... create the diagrams
					// note slightly different syntax here
			Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.SEQUENCE_LITERAL,inter);
			d.setName("Diag_SD_AfterQUntilR_PrecedenceChain2_Pattern_"+random);		
			UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);		
				
			Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.COMMUNICATION_LITERAL,inter);
			cd.setName("Diag_COM_AfterQUntilR_PrecedenceChain2_Pattern_"+random);		
		}
		
		public void draw_afterQPrecedenceChain2(Model m){
			int random = (int )(Math.random() * 5000 + 1);

			Collaboration coll = (Collaboration) m.createPackagedElement("Collab_AfterQ_PrecedenceChain2_Pattern_" + random, UMLPackage.eINSTANCE.getCollaboration());
			Interaction inter = (Interaction) coll.createOwnedBehavior("Inter_AfterQ_PrecedenceChain2_Pattern_" +random, UMLPackage.eINSTANCE.getInteraction());
			afterQ(m, coll, inter);
			...
			// note slightly different syntax here
			Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.SEQUENCE_LITERAL,inter);
			d.setName("Diag_SD_AfterQ_PrecedenceChain2_Pattern_"+random);		
			UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);		
		
			Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.COMMUNICATION_LITERAL,inter);
			cd.setName("Diag_COM_AfterQ_PrecedenceChain2_Pattern_"+random);		
		}
		
		public void draw_globallyPrecedenceChain2(Model m){
			
			int random = (int )(Math.random() * 5000 + 1);

			Collaboration coll = (Collaboration) m.createPackagedElement("Collab_Globally_PrecedenceChain2_Pattern_" + random, UMLPackage.eINSTANCE.getCollaboration());
			Interaction inter = (Interaction) coll.createOwnedBehavior("Inter_Globally_PrecedenceChain2_Pattern_" +random, UMLPackage.eINSTANCE.getInteraction());
			...
			// note slightly different syntax here
			Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.SEQUENCE_LITERAL,inter);
			d.setName("Diag_SD_Globally_PrecedenceChain2_Pattern_"+random);		
			UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);		
		
			Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.COMMUNICATION_LITERAL,inter);
			cd.setName("Diag_COM_Globally_PrecedenceChain2_Pattern_"+random);	
		
		}

		public void draw_betweenQandRPrecedenceChain2(Model m){
			
			int random = (int )(Math.random() * 5000 + 1);

			Collaboration coll = (Collaboration) m.createPackagedElement("Collab_BetweenQandR_PrecedenceChain2_Pattern_" + random, UMLPackage.eINSTANCE.getCollaboration());
			Interaction inter = (Interaction) coll.createOwnedBehavior("Inter_BetweenQandR_PrecedenceChain2_Pattern_" +random, UMLPackage.eINSTANCE.getInteraction());
			afterQ(m, coll, inter);
			precedence_chain2(m,coll, inter);
			beforeR(m,coll,inter);
			...
			// note slightly different syntax here
			Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.SEQUENCE_LITERAL,inter);
			d.setName("Diag_SD_BetweenQandR_PrecedenceChain2_Pattern_"+random);		
			UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);		
		
			Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter, UMLDiagramKind.COMMUNICATION_LITERAL,inter);
			cd.setName("Diag_COM_BetweenQandR_PrecedenceChain2_Pattern_"+random);
		}
	
		public void precedence_chain2(Model m, Collaboration coll, Interaction inter){
