...
public class Precedence extends PropertyPattern {
	Model m;

	public Precedence(Model m) {
		this.m = m;
	}
	...
	public void draw_beforeRPrecedence(Model m) {
		...
		Collaboration coll = (Collaboration) m.createPackagedElement(
				"Collab_BeforeR_Precedence_Pattern_" + random,
				UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior(
				"Inter_Before_Precedence_Pattern_" + random,
				UMLPackage.eINSTANCE.getInteraction());
		...
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.SEQUENCE_LITERAL, inter);
		d.setName("Diag_SD_BeforeR_Precedence_Pattern_" + random);
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);

		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.COMMUNICATION_LITERAL, inter);
		cd.setName("Diag_COM_BeforeR_Precedence_Pattern_" + random);
	...
	public void draw_afterQUntilRPrecedence(Model m) {
		...
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.SEQUENCE_LITERAL, inter);
		d.setName("Diag_SD_AfterQ_UntilR_Precedence_Pattern_" + random);
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);

		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.COMMUNICATION_LITERAL, inter);
		cd.setName("Diag_COM_AfterQ_UntilR_Precedence_Pattern_" + random);
	}
	...
	public void draw_globallyPrecedence(Model m) {
		...
		Collaboration coll = (Collaboration) m.createPackagedElement(
				"Collab_Globally_Precedence_Pattern_" + random,
				UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior(
				"Inter_Globally_Precedence_Pattern_" + random,
				UMLPackage.eINSTANCE.getInteraction());
	...
	public void draw_betweenQandRPrecedence(Model m) {
		...
		Collaboration coll = (Collaboration) m.createPackagedElement(
				"Collab_BetweenQandR_Precedence_Pattern_" + random,
				UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior(
				"Inter_BetweenQandR_Precedence_Pattern_" + random,
				UMLPackage.eINSTANCE.getInteraction());
		afterQ(m, coll, inter);
		precedence(m, coll, inter);
		beforeR(m, coll, inter);
		...
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.SEQUENCE_LITERAL, inter);
		d.setName("Diag_SD_BetweenQandR_Precedence_Pattern_" + random);
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);

		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.COMMUNICATION_LITERAL, inter);
		cd.setName("Diag_COM_BetweenQandR_Precedence_Pattern_" + random);
	}
