package info.remenska.myfirstplugin.views;
...
public class ResourceManagerView extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(viewer.getControl(), "info.remenska.myFirstPlugin.viewer");
		makeActions();
		hookContextMenu();
	...
	private void makeActions() {
		...
		doubleClickAction = new Action() {
			public void run() {
				...
				showMessage("I am a genius! "+obj.toString());
			}
		};
	}
